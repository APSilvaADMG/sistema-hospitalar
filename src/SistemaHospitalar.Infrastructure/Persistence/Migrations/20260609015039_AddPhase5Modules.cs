...
{
    /// <inheritdoc />
    public partial class AddPhase5Modules : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_emergency_visits", x => x.Id);
                    table.ForeignKey(
                        name: "FK_emergency_visits_ai_triage_logs_AiTriageLogId",
                        column: x => x.AiTriageLogId,
                        principalTable: "ai_triage_logs",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_emergency_visits_patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "patients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_emergency_visits_professionals_ProfessionalId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_emergency_visits_AiTriageLogId",
                table: "emergency_visits",
                column: "AiTriageLogId");

            migrationBuilder.CreateIndex(
                name: "IX_emergency_visits_PatientId",
                table: "emergency_visits",
                column: "PatientId");

            migrationBuilder.CreateIndex(
                name: "IX_emergency_visits_ProfessionalId",
                table: "emergency_visits",
